  ...
  return (
    <>
      <div className="py-6 w-full">
        <h2 className="text-4xl font-black font-teko">Projects</h2>
        <ul className="grid grid-cols-3 gap-8 mt-4">
          <li className="border-2 border-black col-span-1 relative group">
            <div className="bg-blue-500 absolute inset-0 opacity-0 group-hover:opacity-75">
          ...
          <li className="border-2 border-black col-span-1">2</li>
          <li className="border-2 border-black col-span-1">3</li>
        </ul>
